...
const hero_contents = {
  ...
  title: 'Making Ambitions a Reality',
  highlight_text: 'Abroad',
  short_text: <>Transforming dreams become global realities with <br /> thorough coaching and assistance for international higher education.</>,
  ...
  social_links: [
    ...
    { num: 2, icon: 'fab fa-instagram social-icon-2', title: 'Instagram',link: 'https://instagram.com/lgrstudyabroad?igshid=MzRlODBiNWFlZA==' },
            ...
            <div className="tp-hero-section-box-five">
              ...
              <div className="tp-hero-section-box-five__input wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                <form onSubmit={e => e.preventDefault()}>
                  <input type="text" placeholder="lgr@gmail.com" />
