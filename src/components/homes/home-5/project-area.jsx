...
const contents = {
  ...
  subtitle: 'Options',
  title: <>Choose Your <span className="tp-section-highlight">
    Option <HighlightThree /> </span></>,
  project_items: [
    { subtitle: 'By LGR', title: 'For Students', img: '/assets/img/project/project-5.1.jpg' },
    { subtitle: 'By LGR', title: 'Recruitment Partners', img: '/assets/img/project/project-5.2.jpg' },
    { subtitle: 'By LGR', title: 'For Universities', img: '/assets/img/project/project-5.3.jpg' },
