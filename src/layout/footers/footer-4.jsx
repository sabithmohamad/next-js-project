...
const footer_contents = {
  ...
  logo: '/assets/img/logo/lgr.png',
  widget_desc: 'guiding students to worldwide academic achievement with professional advice, personalised assistance, and broad university collaborations',
  footer_widgets: [
    {
      w_class: 'd-flex justify-content-lg-center',
      title: 'Useful Links',
      widget_lists: ['Contact us', 'How it Works', 'Students', 'Explore', 'Terms & Services']
    },
    {
      padd: 'pl-20',
      title: 'Community',
  ...
  subscribe_text: 'Get in touch with us for updated news and releases about top universities and lgr',
  copy_right_text: <>© Copyright ©{new Date().getFullYear()} LGR STUDYABROAD. All Rights Reserved Copyright</>,
