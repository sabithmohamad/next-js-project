...
const social_links=[
  ...
  {link: 'https://instagram.com/lgrstudyabroad?igshid=MzRlODBiNWFlZA==', target: '_blank', icon: 'fab fa-instagram'},
...
const hero_socials = [
  ...
  { num: 2,link:'https://instagram.com/lgrstudyabroad?igshid=MzRlODBiNWFlZA==',target: '_blank',icon:'fab fa-instagram social-icon-2', title: 'Instagram' },
]
